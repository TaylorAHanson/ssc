"""
Training Links informational state machine.
...
@workflow(request_types=RequestType.TRAINING_LINKS, feature_flag="core")
class TrainingLinksStateMachine(BaseRequestStateMachine):
