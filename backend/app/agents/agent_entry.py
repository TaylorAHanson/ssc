"""MLflow "models from code" entry point for the self-service ResponsesAgent.
...
:class:`~app.agents.responses_agent.SelfServiceResponsesAgent`, so the governed
ToolExecutor, OBO identity, and MLflow tracing behave identically on every
surface.
"""
import mlflow

from app.agents.responses_agent import SelfServiceResponsesAgent

# The default tool set (AGENT_TOOLS) is bound inside SelfServiceResponsesAgent.__init__.
mlflow.models.set_model(SelfServiceResponsesAgent())
