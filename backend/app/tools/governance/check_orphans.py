...
class CheckOrphanedAssetsInput(BaseModel):
    asset_type: Literal["CATALOG", "SCHEMA", "TABLE", "ALL"] = Field("CATALOG", description="Type of asset to check.")

@tool(
    name="check_orphaned_assets",
    description="Identifies catalogs, schemas, or tables owned by users who are no longer active or valid in the workspace.",
