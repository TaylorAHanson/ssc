...
action := common.resolve_action(is_violation, has_approved, has_pending, "BLOCK")
...
severity := common.resolve_severity(is_violation, has_approved, has_pending, "CRITICAL")
