package databricks.governance.workspaces_and_environments
...
violation_reasons[msg] {
    ...
    msg := "Idle ad-hoc workspaces (no interactive sessions or jobs for 60+ days) are automatically archived and then deleted."
}
...
action := common.resolve_action(is_violation, has_approved, has_pending, "DELETE")
