...
# === Rule catalog ===
rule_metadata := {
	"ad_hoc_workspace_not_idle": "Ad-hoc workspace not idle >90 days",
}

# === Applicability ===
applies contains "ad_hoc_workspace_not_idle" if {
	input.resource.type == "workspace"
	input.workspace.type == "ad-hoc"
}

# === Violations ===
violations["ad_hoc_workspace_not_idle"] contains msg if {
	applies["ad_hoc_workspace_not_idle"]
